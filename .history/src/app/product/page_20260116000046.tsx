...
export default function ProductPage() {
  ...
  return (
    ...
    >
          ...
          {activeTab === 'agentic' && (
            ...
            >
              <div className="max-w-2xl mx-auto space-y-6">
                ...
                {/* Agentic Mode Entry */}
                <AgenticModeButton onClick={() => setShowAgenticMode(true)} />
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    <Target className="w-6 h-6 mb-2 text-[hsl(var(--theme-primary))]" />
                    <h3 className="font-medium text-[hsl(var(--theme-foreground))]">Problem Framing</h3>
                    <p className="text-sm text-[hsl(var(--theme-muted-foreground))]">Define what you're solving</p>
                  </button>
                  <button
              ...
              <div className="max-w-3xl mx-auto">
                ...
                >
                  ...
                  <p className="text-sm text-[hsl(var(--theme-muted-foreground))] opacity-60">
                    AI James will help generate your PRD based on your inputs
                  </p>
                </div>
              </div>
            </motion.div>
      ...
      {/* Agentic Mode Modal */}
      <AgenticMode isOpen={showAgenticMode} onClose={() => setShowAgenticMode(false)} />
    </div>
  );
}
