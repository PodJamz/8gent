...
const STORAGE_KEYS = {
  notes: 'jamesos.notes',
  folders: 'jamesos.notes.folders',
  selectedNoteId: 'jamesos.notes.selectedNoteId',
  selectedFolderId: 'jamesos.notes.selectedFolderId',
  sortBy: 'jamesos.notes.sortBy',
  viewMode: 'jamesos.notes.viewMode',
} as const;
