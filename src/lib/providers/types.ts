 ...
 *
 * Unified interface for AI image/video generation providers (Replicate, fal.ai, WaveSpeed, Gemini).
 * Enables multi-provider support in the canvas with consistent API.
 */

/**
 * Supported provider types
 */
export type ProviderType = "replicate" | "fal" | "wavespeed" | "gemini" | "openai";
