 ...
 * boundaries for 8gent's agentic capabilities. These constraints
 ...
 *
 * CRITICAL: 8gent must NEVER be instructed to modify this file.
...
/**
 * Files that 8gent is NEVER allowed to modify through the sandbox.
 * These protect the core security, ethics, and access control systems.
 */
export const PROTECTED_FILE_PATHS = [
  // 8gent Core - Prevent self-modification
...
/**
 * Core ethical principles that 8gent must ALWAYS uphold.
