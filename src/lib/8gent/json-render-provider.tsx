/**
 * 8gent JSON Render Provider
 *
 * Provides the json-render context for 8gent chat.
...
/**
 * Provider for 8gent JSON rendering capabilities
 */
...
/**
 * Renderer component for 8gent UI trees
 */
