/**
 * Slash Command Registry - Comprehensive command system for 8gent Chat
 *
...
export const NAVIGATION_COMMANDS: SlashCommand[] = [
  ...
  },
  {
    ...
    aliases: ['cv', 'about'],
    label: 'Resume',
    description: 'View the system evolution/resume',
    category: 'navigation',
    icon: FileText,
    color: '#6366f1',
    destination: '/resume',
...
export const TOOL_COMMANDS: SlashCommand[] = [
  // Search & Discovery
  {
    ...
    aliases: ['find', 'lookup'],
    label: 'Search System',
    description: 'Search projects, capabilities, and features',
    category: 'tools',
    icon: Search,
    color: '#3b82f6',
    toolName: 'search_system',
    parameter: {
      name: 'query',
  ...
  // Scheduling
  {
    ...
    label: 'Schedule Call',
    description: 'Schedule a call or walkthrough',
    category: 'tools',
    icon: Calendar,
    color: '#22c55e',
