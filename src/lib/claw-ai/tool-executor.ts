...
import { searchPortfolio, getAllThemes, formatSearchResults, SearchOptions } from './search';
...
// ============================================================================
// NETWORK WHITELISTING - Phase 1.5 ∞gent Safety Stack
// ============================================================================
...
function executeSearchPortfolio(
  args: Record<string, unknown>
): ToolResult {
  ...
  const results = searchPortfolio(query, { category, limit: 8 });
