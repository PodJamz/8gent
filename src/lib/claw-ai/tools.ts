...
export interface ToolResult {
  ...
  error?: string;
  action?: ToolAction;
  // Approval system (Phase 1.2 - ∞gent Safety Stack)
  ...
  // Cost estimation (Phase 1.3 - ∞gent Safety Stack)
  costEstimate?: {
...
export const CLAW_AI_TOOLS: ToolDefinition[] = [
  {
    ...
    description:
      'Search through the system including projects, skills, work experience, and education. Use this when users ask about professional background, skills, or projects.',
    parameters: {
      type: 'object',
      properties: {
        query: {
  ...
  },
  {
    name: 'navigate_to',
    description:
      'Navigate the user to a specific page in the portfolio. Use this when users want to see specific content like the design showcase, resume, projects, blog, or music.',
    parameters: {
      type: 'object',
      properties: {
        destination: {
  ...
  },
  {
    name: 'list_themes',
    description:
      'List all available design themes in the portfolio. Use this when users ask about themes, design options, or want to explore the design showcase.',
    parameters: {
      type: 'object',
      properties: {
        category: {
  ...
  },
  {
    ...
    description:
      'Open the Search app with a specific query. Use this when users want to explore search results in detail, or when search results would be better viewed in the full Search app rather than inline in chat. This closes the Claw AI chat and opens the Search app with the query pre-filled.',
    parameters: {
      type: 'object',
      properties: {
        query: {
  ...
  },
  {
    ...
    description:
      'Transform an image to match OpenClaw-OS branded visual identity. Applies consistent effects ' +
...

  {
    ...
    description:
      ...
      'IMPORTANT: This is how Claw AI does real work autonomously.',
    parameters: {
      type: 'object',
      properties: {
        task: {
  ...
  },
  {
    ...
    description:
      'Start an autonomous code iteration session. Claw AI will analyze code, make changes, ' +
