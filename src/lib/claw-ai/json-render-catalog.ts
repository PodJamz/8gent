/**
 * Claw AI Component Catalog for json-render
 *
 * Defines the guardrailed components Claw AI can render in chat.
...
// Generate the prompt for Claw AI to understand how to use the catalog
