...
function ChannelConnectionModal({
  ...
  const platformConfig = {
    whatsapp: {
      ...
      description: 'Link your WhatsApp to receive Claw AI messages.',
      fields: [
    ...
    slack: {
      title: 'Connect Slack',
      description: 'Install the Claw AI app to your Slack workspace.',
      fields: [
    ...
    discord: {
      ...
      description: 'Add the Claw AI bot to your Discord server.',
      fields: [
    ...
    email: {
      title: 'Connect Email',
      description: 'Receive Claw AI responses via email.',
      fields: [
        { key: 'platformUserId', label: 'Your Email Address', placeholder: 'you@example.com', required: true },
        { key: 'platformUsername', label: 'Display Name', placeholder: 'Your name', required: false },
      ],
      note: 'Send emails to ai@openclaw.io to chat with Claw AI.',
    },
  };
        ...
        <main className="max-w-lg mx-auto px-4 py-6">
          ...
          >
            <p className="text-sm text-amber-200/80">
              Connect your accounts to unlock additional features like the ∞gent coding assistant.
            </p>
          </motion.div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  >
                    <IntegrationCard
                      name="GitHub"
                      description="Connect GitHub to use the ∞gent coding assistant and access your repositories."
                  ...
                  >
                    {(() => {
                      ...
                      return (
                        <IntegrationCard
                          name="WhatsApp"
                          description="Chat with Claw AI through WhatsApp. Perfect for on-the-go conversations."
                  ...
                  >
                    {(() => {
                      ...
                      return (
                        <IntegrationCard
                          name="Telegram"
                          description="Connect your Telegram bot for instant Claw AI access via Telegram."
                  ...
                  >
                    {(() => {
                      ...
                      return (
                        <IntegrationCard
                          name="Slack"
                          description="Bring Claw AI to your Slack workspace for team-accessible AI assistance."
                  ...
                  >
                    {(() => {
                      ...
                      return (
                        <IntegrationCard
                          name="Discord"
                          description="Add Claw AI to your Discord server for chat-based AI interactions."
                          icon={
                  ...
                  >
                    {(() => {
                      ...
                      return (
                        <IntegrationCard
                          name="Email"
                          description="Chat with Claw AI via email at ai@openclaw.io."
