...
const chapters: Chapter[] = [
  {
    id: 'origin',
    title: 'The Seed',
    subtitle: 'From creative energy to technical architecture',
    emoji: '🎸',
    highlight: 'Conceptual Phase',
    content: [
      "The engine behind 8gent began as a quest to bridge the gap between creative expression and computational logic. It started with an obsession for how we organize thoughts, sounds, and systems into meaningful structures.",
      "Early experiments focused on immersive environments and real-time feedback loops. This required a deep immersion into the mechanics of both technical engineering and product-led design, learning how to build not just tools, but ecosystems.",
      "The goal was clear from the start: create a digital workspace that feels as alive and responsive as a physical instrument. A system that adapts to the user's intent.",
    ],
  },
  {
    id: 'pivot',
  ...
  },
  {
    ...
    emoji: '👶',
    highlight: 'Architecting Foundation',
    content: [
      "The real catalyst for 8gent was the realization that existing interfaces lacked the empathy and pattern-recognition required for neurodivergent and high-context users. The system needed more than just code; it needed a soul.",
      "We took the plunge into agentic orchestration. Moving away from static hierarchies to a fluid, conversation-based control plane. This transition marked the birth of the 8gent core.",
      "The result is a self-contained unit that multiplies the productivity of everyone around it, spanning product design, AI engineering, and multi-agent management.",
    ],
  },
  {
    id: 'voala',
      ...
      <div ref={containerRef} className="min-h-screen bg-background relative overflow-hidden">
        ...
        <nav className="fixed right-6 top-1/2 -translate-y-1/2 z-50 hidden lg:flex flex-col gap-3">
          {chapters.map((chapter, index) => (
            <button
              ...
              className={`w-3 h-3 rounded-full transition-all ${activeChapter === index
        ...
        <section className="min-h-screen flex flex-col items-center justify-center relative px-6">
          <div className="text-center max-w-3xl">
            ...
            >
              The journey of an AI-native operating system
            </TextEffect>
