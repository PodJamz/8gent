...
const FALLBACK_MILESTONES: Omit<Milestone, '_id'>[] = [
  {
    ...
    description: "8gent voice chat and desktop screensaver",
  ...
  },
  {
    ...
    features: ["Drag-and-drop app icons", "Folder system", "Lock screen with unlock", "Dynamic Island with music", "Dock with 8gent orb"],
  ...
  },
  {
    ...
    features: ["8-chapter story structure", "Scroll-driven animations", "Progressive disclosure", "Paper notebook aesthetic", "Self-teaching workflow"],
  ...
  },
  {
    phase: 1,
    title: "Foundation",
    description: "System template, blog system, password-protected vault",
